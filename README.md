...
- **Containerização:** Docker com estratégia **Multi-Stage Build**.
  - *Stage 1 (Builder):* Node.js 24-alpine para instalar dependências (npm ci) e gerar os arquivos estáticos.
  - *Stage 2 (Runner):* Nginx 1.29-alpine para servir o conteúdo. Imagem final extremamente leve (<40MB).
